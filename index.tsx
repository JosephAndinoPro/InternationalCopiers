...
const productData = [
  // B&N
  { id: 'mp301', name: 'Ricoh MP 301', priceUSD: 450, stock: 'agotado', videoUrl: 'AxODTHVNfBM', image: 'images/17.jpg', type: 'B/N', speedPPM: 30, functions: ['Impresión', 'Escaneo', 'Copia'], paperSize: ['A4'], status: 'Remanofacturado', benefits: ['Compacto y eficiente', 'Ideal para pequeñas oficinas', 'Tóner económico'] },
  { id: 'im350', name: 'Ricoh IM 350', priceUSD: 475, stock: 'disponible', videoUrl: 'EwXqXBcVQrM', image: 'images/10.jpg', type: 'B/N', speedPPM: 35, functions: ['Impresión', 'Escaneo', 'Copia', 'Fax (opcional)'], paperSize: ['A4'], status: 'Remanofacturado', benefits: ['Pantalla táctil intuitiva', 'Conectividad avanzada', 'Bajo consumo energético'] },
  { id: 'mp2555', name: 'Ricoh MP 2555', priceUSD: 980, stock: 'disponible', videoUrl: 'plFbhqrOF9s', image: 'images/8.jpg', type: 'B/N', speedPPM: 25, functions: ['Impresión', 'Escaneo', 'Copia'], paperSize: ['A3', 'A4'], status: 'Remanofacturado', benefits: ['Alimentador de documentos rápido', 'Funciones de seguridad mejoradas', 'Operación silenciosa'] },
  { id: 'mp3055', name: 'Ricoh MP 3055', priceUSD: 1200, stock: 'agotado', videoUrl: 't7X9a4yUW5A', image: 'images/11.jpg', type: 'B/N', speedPPM: 30, functions: ['Impresión', 'Escaneo', 'Copia', 'Fax'], paperSize: ['A3', 'A4'], status: 'Remanofacturado', benefits: ['Pantalla táctil a color personalizable', 'Integración con la nube', 'Alta durabilidad'] },
  { id: 'mp4055', name: 'Ricoh MP 4055', priceUSD: 1410, stock: 'disponible', videoUrl: 't7X9a4yUW5A', image: 'images/9.jpg', type: 'B/N', speedPPM: 40, functions: ['Impresión', 'Escaneo', 'Copia', 'Fax'], paperSize: ['A3', 'A4'], status: 'Remanofacturado', benefits: ['Alta velocidad para grupos de trabajo', 'Opciones de finalizado avanzadas', 'Eficiencia energética superior'] },
  { id: 'mp5054', name: 'Ricoh MP 5054', priceUSD: 1310, stock: 'disponible', videoUrl: 'iCvsiCR24N8', image: 'images/13.jpg', type: 'B/N', speedPPM: 50, functions: ['Impresión', 'Escaneo', 'Copia', 'Fax'], paperSize: ['A3', 'A4'], status: 'Remanofacturado', benefits: ['Rendimiento robusto', 'Calidad de impresión profesional', 'Panel de operación personalizable'] },
  { id: 'mp5055', name: 'Ricoh MP 5055', priceUSD: 1640, stock: 'disponible', videoUrl: 'SBSFICiZDUA', image: 'images/13.jpg', type: 'B/N', speedPPM: 50, functions: ['Impresión', 'Escaneo', 'Copia', 'Fax'], paperSize: ['A3', 'A4'], status: 'Remanofacturado', benefits: ['Rendimiento robusto para alto volumen', 'Calidad de impresión profesional', 'Fácil administración remota'] },
  { id: 'mp6055', name: 'Ricoh MP 6055', priceUSD: 1895, stock: 'agotado', videoUrl: 'T6Gj-hazaSU', image: 'images/14.jpg', type: 'B/N', speedPPM: 60, functions: ['Impresión', 'Escaneo', 'Copia', 'Fax (opcional)'], paperSize: ['A3', 'A4'], status: 'Remanofacturado', benefits: ['Máxima productividad para grandes departamentos', 'Tecnología de imagen avanzada', 'Bajo costo por página'] },
  { id: 'mp7503', name: 'Ricoh MP 7503', priceUSD: 2970, stock: 'disponible', videoUrl: '05wFKCMdcKQ', image: 'images/16.jpg', type: 'B/N', speedPPM: 75, functions: ['Impresión', 'Escaneo', 'Copia'], paperSize: ['A3', 'A4'], status: 'Remanofacturado', benefits: ['Velocidad extrema para entornos de producción ligera', 'Capacidad de papel expandible', 'Durabilidad industrial'] },
  // Color
  { id: 'mpc4504ex', name: 'Ricoh MP C4504ex', priceUSD: 1490, stock: 'disponible', videoUrl: 'hoaq5mBaDV4', image: 'images/4.jpg', type: 'Color', speedPPM: 45, functions: ['Impresión', 'Escaneo', 'Copia', 'Fax'], paperSize: ['A3', 'A4'], status: 'Remanofacturado', benefits: ['Colores vibrantes y precisos', 'Smart Operation Panel', 'Conectividad LAN y móvil'] },
  { id: 'mpc5503', name: 'Ricoh MPC 5503', priceUSD: 1290, stock: 'disponible', videoUrl: '4x8HN9GfEa4', image: 'images/2.jpg', type: 'Color', speedPPM: 55, functions: ['Impresión', 'Escaneo', 'Copia', 'Fax (opcional)'], paperSize: ['A3', 'A4'], status: 'Remanofacturado', benefits: ['Calidad de color superior', 'Panel táctil intuitivo', 'Eficiencia energética'] },
  { id: 'mpc6004ex', name: 'Ricoh MP C6004ex', priceUSD: 1890, stock: 'disponible', videoUrl: '4eyeD3JW-98', image: 'images/6.jpg', type: 'Color', speedPPM: 60, functions: ['Impresión', 'Escaneo', 'Copia', 'Fax'], paperSize: ['A3', 'A4'], status: 'Remanofacturado', benefits: ['Alta velocidad a color', 'Calidad profesional de marketing', 'Ahorro energético modo suspensión'] }
];
...
const CompanyIntroSlide = () => (
    <div className="slide-content content-slide">
        ...
        <ul>
            <li>Venta de equipos Ricoh multifuncionales (todos nuestros equipos son Remanofacturados).</li>
...
const WarrantySlide = () => (
    <div className="slide-content content-slide warranty-slide" style={{textAlign: "center", paddingTop: "80px"}}>
        ...
        <p><strong>Para Equipos Adquiridos (Venta):</strong> Todos nuestros equipos Remanofacturados cuentan con una garantía de <strong>6 meses o 10,000 copias</strong> (lo que se cumpla primero).</p>
